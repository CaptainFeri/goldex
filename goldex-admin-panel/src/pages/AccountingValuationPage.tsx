...
function SettingsCard({ settings }: { settings: AccountingSettings }) {
  ...
  const save = useMutation({
    mutationFn: () =>
      api.patch("/admin/accounting/valuation/settings", {
        referenceSymbolId,
        valuationBasis,
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["accounting-valuation-settings"] });
      qc.invalidateQueries({ queryKey: ["accounting-valuation-summary"] });
      qc.invalidateQueries({ queryKey: ["accounting-valuation-holdings"] });
    },
  });
...
export default function AccountingValuationPage() {
  ...
  const settings = useQuery({
    queryKey: ["accounting-valuation-settings"],
    queryFn: async () =>
      unwrap<AccountingSettings>(
        (await api.get("/admin/accounting/valuation/settings")).data,
      ),
  });

  const summary = useQuery({
    queryKey: ["accounting-valuation-summary", range],
    queryFn: async () =>
      unwrap<Summary>(
        (
          await api.get("/admin/accounting/valuation/summary", {
  ...
  const holdings = useQuery({
    queryKey: ["accounting-valuation-holdings"],
    queryFn: async () =>
      unwrap<any>((await api.get("/admin/accounting/valuation/holdings")).data),
  });
