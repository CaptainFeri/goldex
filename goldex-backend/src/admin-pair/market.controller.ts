...
export class MarketController {
  ...
  private toMarketView(p: PricePairEntity, routes?: PairRoutes) {
    ...
    return {
      ...
      buyDeadlineMode: p.buyDeadlineMode ?? null,
      sellDeadlineMode: p.sellDeadlineMode ?? null,
      buyWarnTime: p.buyWarnTime ?? null,
      buyExpireTime: p.buyExpireTime ?? null,
      sellWarnTime: p.sellWarnTime ?? null,
      sellExpireTime: p.sellExpireTime ?? null,
      deadlineTimezone: p.deadlineTimezone ?? null,
      holidayDates: p.holidayDates ?? null,
