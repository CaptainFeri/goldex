...
export class ShahinProxyController {
  ...
  constructor(
    ...
    this.microserviceUrl = this.configService.get('SHAHIN_SERVICE_URL', 'https://9eb6cj.parszargar.com');
    ...
    if (this.microserviceUrl.length < 50) {
      ...
      this.logger.error(`Expected full URL: https://9eb6cj.parszargar.com`);
    }
  }
